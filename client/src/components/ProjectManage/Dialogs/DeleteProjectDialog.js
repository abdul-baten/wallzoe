  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <DialogActions>
          <Button onClick={(event) => onDeleteProjectHandler(deleteProject, data._id, false, event)} color="primary">
            Archive the project
          </Button>
          <Button onClick={(event) => onDeleteProjectHandler(deleteProject, data._id, true, event)} color="primary">
            Put it in the trash
          </Button>
        </DialogActions>
      </Dialog>
